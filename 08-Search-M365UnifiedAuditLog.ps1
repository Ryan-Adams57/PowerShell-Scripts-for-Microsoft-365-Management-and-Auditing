<#
====================================================================================
Script Name: Search-M365UnifiedAuditLog.ps1
Description: Comprehensive Unified Audit Log search and analysis tool
Author: Ryan Adams
Website: https://www.governmentcontrol.net/
====================================================================================

SCRIPT HIGHLIGHTS:
• Searches Microsoft 365 Unified Audit Log (UAL)
• Supports all record types and operations
• Handles pagination for large result sets (up to 50,000 results)
• Respects 90-day audit log retention limits
• Supports filtering by user, activity, workload, and date range
• Processes and expands JSON audit data
• Generates detailed forensic-ready CSV reports
