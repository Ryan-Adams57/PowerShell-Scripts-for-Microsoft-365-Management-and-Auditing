<#
====================================================================================
Script Name: Get-M365TeamsMeetingAttendanceReport.ps1
Description: Teams meeting attendance tracking and analytics report
Author: Ryan Adams
Website: https://www.governmentcontrol.net/
====================================================================================

SCRIPT HIGHLIGHTS:
• Retrieves Teams meeting attendance records
• Shows participant join/leave times
• Calculates meeting duration and attendance rates
• Identifies external participants
• Supports date range filtering
• Generates meeting analytics and trends
• Exports detailed attendance CSV reports
