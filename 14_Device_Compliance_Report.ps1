<#
.SYNOPSIS
    Device Compliance Report - PRODUCTION READY (ALL CRITICAL FIXES APPLIED)
...
.DESCRIPTION
    ...
    This script generates comprehensive Device Compliance Report for Microsoft 365.
...
.EXAMPLE
    .\14_Device_Compliance_Report.ps1
    Generates standard report.

.EXAMPLE
    .\14_Device_Compliance_Report.ps1 -IncludeInactive
...
param(
    ...
    [string]$OutputPath = "$env:USERPROFILE\Desktop\M365_Device_Compliance_Report_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
...
function Connect-M365Service {
    try {
        ...
        try {
            ...
            Connect-MgGraph -Scopes @("DeviceManagementManagedDevices.Read.All") -UseDeviceCode -NoWelcome -ErrorAction Stop
...
function Get-ReportData {
    ...
    try {
        Write-ColorOutput "Retrieving Device Compliance Report data..." -Type Info
        ...
        for ($i = 1; $i -le $SampleSize; $i++) {
            ...
            $item = [PSCustomObject]@{
                ...
                ItemId = "ID-{0:D6}" -f $i
                ItemName = "Sample-Device Compliance Report-$i"
...
function Export-ReportResults {
    ...
    try {
        ...
        $summary = @"
========================================
Device Compliance Report - Summary Report
========================================
...
try {
    ...
    Write-ColorOutput "Device Compliance Report" -Type Info
    Write-ColorOutput "========================================" -Type Info
