<#
====================================================================================
Script Name: Get-M365ConditionalAccessPoliciesReport.ps1
Description: Conditional Access Policies Configuration Report
Author: Ryan Adams
...
• Shows policy conditions, controls, and assignments
• Identifies enabled vs report-only vs disabled policies
• Lists included/excluded users, groups, and roles
• Shows application and platform assignments
• Highlights policy conflicts and coverage gaps
• Generates comprehensive policy documentation
