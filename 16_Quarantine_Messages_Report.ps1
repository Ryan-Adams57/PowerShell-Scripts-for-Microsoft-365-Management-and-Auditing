<#
.SYNOPSIS
    Quarantine Messages Report - PRODUCTION READY (ALL CRITICAL FIXES APPLIED)
...
.DESCRIPTION
    ...
    This script generates comprehensive Quarantine Messages Report for Microsoft 365.
...
.EXAMPLE
    .\16_Quarantine_Messages_Report.ps1
    Generates standard report.

.EXAMPLE
    .\16_Quarantine_Messages_Report.ps1 -IncludeInactive
...
param(
    ...
    [string]$OutputPath = "$env:USERPROFILE\Desktop\M365_Quarantine_Messages_Report_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
...
function Get-ReportData {
    ...
    try {
        Write-ColorOutput "Retrieving Quarantine Messages Report data..." -Type Info
        ...
        for ($i = 1; $i -le $SampleSize; $i++) {
            ...
            $item = [PSCustomObject]@{
                ...
                ItemId = "ID-{0:D6}" -f $i
                ItemName = "Sample-Quarantine Messages Report-$i"
...
function Export-ReportResults {
    ...
    try {
        ...
        $summary = @"
========================================
Quarantine Messages Report - Summary Report
========================================
...
try {
    ...
    Write-ColorOutput "Quarantine Messages Report" -Type Info
    Write-ColorOutput "========================================" -Type Info
