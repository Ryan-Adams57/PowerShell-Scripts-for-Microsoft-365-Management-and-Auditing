<#
====================================================================================
Script Name: Get-M365TeamsExternalAccessReport.ps1
Description: Teams External and Guest Access Configuration Report
Author: Ryan Adams
Website: https://www.governmentcontrol.net/
====================================================================================

SCRIPT HIGHLIGHTS:
• Shows Teams external access (federation) settings
• Lists allowed and blocked external domains
• Identifies teams with guest members
• Shows guest access permissions and restrictions
• Highlights federation and guest access policies
• Generates security and compliance audit reports
• Exports external collaboration inventory
• Critical for data governance and security reviews
