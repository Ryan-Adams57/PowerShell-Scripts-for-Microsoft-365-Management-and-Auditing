<#
====================================================================================
Script Name: Audit-M365AdminActivityReport.ps1
...
SCRIPT HIGHLIGHTS:
• Tracks all admin portal activities and changes
• Shows configuration changes made by administrators
• Lists role assignments, modifications, and removals
• Identifies security setting modifications
• Supports activity type and admin user filtering
• Generates comprehensive compliance audit trails
• Exports admin action history and evidence CSV
• Essential for security monitoring and governance
...
if ($results.Count -gt 0) {
    ...
    Write-Host "  Total Admin Actions: $($results.Count)" -ForegroundColor White
    Write-Host "  Unique Admins: $(($results | Select-Object -Unique AdminUser).Count)" -ForegroundColor White
    Write-Host "  Unique Operations: $(($results | Select-Object -Unique Operation).Count)" -ForegroundColor White
    
    Write-Host "`n  Top Admin Operations:" -ForegroundColor Cyan
    $results | Group-Object Operation | Sort-Object Count -Descending | Select-Object -First 5 | ForEach-Object {
        Write-Host "    $($_.Name): $($_.Count)" -ForegroundColor White
    }
    
    Write-Host "`n  Top Administrators:" -ForegroundColor Cyan
    $results | Group-Object AdminUser | Sort-Object Count -Descending | Select-Object -First 5 | ForEach-Object {
    ...
    $results | Select-Object -First 10 | Format-Table TimeStamp, AdminUser, Operation, Workload, ResultStatus -AutoSize
