<#
====================================================================================
Script Name: Get-M365DLPPolicyReport.ps1
...
SCRIPT HIGHLIGHTS:
• Retrieves all DLP policies across Exchange, SharePoint, OneDrive, Teams
• Shows policy rules, conditions, and actions
• Identifies DLP policy matches and incidents
• Tracks sensitive information type detections
• Supports filtering by workload and policy status
• Generates compliance and data protection reports
• Exports detailed DLP configuration and activity
• Critical for regulatory compliance (GDPR, HIPAA, PCI-DSS)
...
if ($results.Count -gt 0) {
    ...
    $results | Where-Object { $_.PolicyName } | Group-Object { 
    ...
    $results | Select-Object -First 10 | Format-Table PolicyName, Enabled, Mode, Workloads, RuleCount -AutoSize
