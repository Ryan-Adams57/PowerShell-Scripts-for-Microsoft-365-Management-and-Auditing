<#
.SYNOPSIS
    DLP Policy Matches Report - PRODUCTION READY (ALL CRITICAL FIXES APPLIED)
...
.DESCRIPTION
    ...
    This script generates comprehensive DLP Policy Matches Report for Microsoft 365.
...
.EXAMPLE
    .\33_DLP_Policy_Matches_Report.ps1
    Generates standard report.

.EXAMPLE
    .\33_DLP_Policy_Matches_Report.ps1 -IncludeInactive
...
param(
    ...
    [string]$OutputPath = "$env:USERPROFILE\Desktop\M365_DLP_Policy_Matches_Report_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
...
function Get-ReportData {
    ...
    try {
        Write-ColorOutput "Retrieving DLP Policy Matches Report data..." -Type Info
        ...
        for ($i = 1; $i -le $SampleSize; $i++) {
            ...
            $item = [PSCustomObject]@{
                ...
                ItemId = "ID-{0:D6}" -f $i
                ItemName = "Sample-DLP Policy Matches Report-$i"
...
function Export-ReportResults {
    ...
    try {
        ...
        $summary = @"
========================================
DLP Policy Matches Report - Summary Report
========================================
...
try {
    ...
    Write-ColorOutput "DLP Policy Matches Report" -Type Info
    Write-ColorOutput "========================================" -Type Info
