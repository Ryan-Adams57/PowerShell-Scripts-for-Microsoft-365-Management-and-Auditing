<#
====================================================================================
Script Name: Get-AzureADB2BCollaborationReport.ps1
...
SCRIPT HIGHLIGHTS:
• Retrieves Azure AD B2B collaboration policy settings
• Shows external sharing and guest access configurations
• Lists allowed/blocked domains for B2B collaboration
• Identifies guest invite settings and restrictions
• Tracks cross-tenant access settings
• Supports organizational relationships inventory
• Generates external collaboration governance reports
• Critical for security and compliance management
...
if ($results.Count -gt 0) {
    ...
    Write-Host "  Total Settings Retrieved: $($results.Count)" -ForegroundColor White
    ...
    $results | Select-Object -First 10 | Format-Table Category, Setting, Value, Enabled -AutoSize
