<#
.SYNOPSIS
    Sensitivity Labels Report - PRODUCTION READY (ALL CRITICAL FIXES APPLIED)
...
.DESCRIPTION
    ...
    This script generates comprehensive Sensitivity Labels Report for Microsoft 365.
...
.EXAMPLE
    .\41_Sensitivity_Labels_Report.ps1
    Generates standard report.

.EXAMPLE
    .\41_Sensitivity_Labels_Report.ps1 -IncludeInactive
...
param(
    ...
    [string]$OutputPath = "$env:USERPROFILE\Desktop\M365_Sensitivity_Labels_Report_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
...
function Get-ReportData {
    ...
    try {
        Write-ColorOutput "Retrieving Sensitivity Labels Report data..." -Type Info
        ...
        for ($i = 1; $i -le $SampleSize; $i++) {
            ...
            $item = [PSCustomObject]@{
                ...
                ItemId = "ID-{0:D6}" -f $i
                ItemName = "Sample-Sensitivity Labels Report-$i"
...
function Export-ReportResults {
    ...
    try {
        ...
        $summary = @"
========================================
Sensitivity Labels Report - Summary Report
========================================
...
try {
    ...
    Write-ColorOutput "Sensitivity Labels Report" -Type Info
    Write-ColorOutput "========================================" -Type Info
