...
<#
====================================================================================
Script Name: 44-Get-IntuneConfigurationProfilesReport.ps1
...
param(
    ...
    [string]$ExportPath = ".\\M365_Report_44_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)
...
Write-Host "Microsoft 365 Report - Script 44 (Expanded)" -ForegroundColor Green
Write-Host "====================================================================================`n" -ForegroundColor Cyan

# Module validation
$requiredModule = if (44 -eq 43) { "MicrosoftTeams" } elseif (44 -ge 44 -and 44 -le 45) { "Microsoft.Graph.Intune" } else { "ExchangeOnlineManagement" }
...
# Main logic
Write-Host "Retrieving data for script 44..." -ForegroundColor Cyan
$script:Results = @()
...
Write-Host "Script 44 completed.`n" -ForegroundColor Green
