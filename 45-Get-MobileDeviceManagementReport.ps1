...
<#
====================================================================================
Script Name: 45-Get-MobileDeviceManagementReport.ps1
...
param(
    ...
    [string]$ExportPath = ".\\M365_Report_45_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)
...
Write-Host "Microsoft 365 Report - Script 45 (Expanded)" -ForegroundColor Green
Write-Host "====================================================================================`n" -ForegroundColor Cyan

# Module validation
$requiredModule = if (45 -eq 43) { "MicrosoftTeams" } elseif (45 -ge 44 -and 45 -le 45) { "Microsoft.Graph.Intune" } else { "ExchangeOnlineManagement" }
...
# Main logic
Write-Host "Retrieving data for script 45..." -ForegroundColor Cyan
$script:Results = @()
...
Write-Host "Script 45 completed.`n" -ForegroundColor Green
