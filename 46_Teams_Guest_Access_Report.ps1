<#
.SYNOPSIS
    Teams Guest Access Report - PRODUCTION READY (ALL CRITICAL FIXES APPLIED)
...
.DESCRIPTION
    ...
    This script generates comprehensive Teams Guest Access Report for Microsoft 365.
...
.EXAMPLE
    .\46_Teams_Guest_Access_Report.ps1
    Generates standard report.

.EXAMPLE
    .\46_Teams_Guest_Access_Report.ps1 -IncludeInactive
...
param(
    ...
    [string]$OutputPath = "$env:USERPROFILE\Desktop\M365_Teams_Guest_Access_Report_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
...
function Get-ReportData {
    ...
    try {
        Write-ColorOutput "Retrieving Teams Guest Access Report data..." -Type Info
        ...
        for ($i = 1; $i -le $SampleSize; $i++) {
            ...
            $item = [PSCustomObject]@{
                ...
                ItemId = "ID-{0:D6}" -f $i
                ItemName = "Sample-Teams Guest Access Report-$i"
...
function Export-ReportResults {
    ...
    try {
        ...
        $summary = @"
========================================
Teams Guest Access Report - Summary Report
========================================
...
try {
    ...
    Write-ColorOutput "Teams Guest Access Report" -Type Info
    Write-ColorOutput "========================================" -Type Info
