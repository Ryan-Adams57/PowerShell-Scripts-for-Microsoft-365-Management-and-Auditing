...
<#
====================================================================================
Script Name: 48-Get-InformationBarriersReport.ps1
Description: Microsoft 365 Advanced Reporting Script 48
...
param(
    ...
    [string]$ExportPath = ".\\M365_Advanced_Report_48_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)
...
Write-Host "Microsoft 365 Advanced Report - Script 48" -ForegroundColor Green  
Write-Host "====================================================================================`n" -ForegroundColor Cyan

# Module validation
$requiredModule = if (48 -eq 49) { "Microsoft.Graph.Identity.Governance" } else { "ExchangeOnlineManagement" }
...
Write-Host "Retrieving M365 data for script 48..." -ForegroundColor Cyan
$script:Results = @()
...
try {
    ...
    $reportData = @{
        ScriptNumber = 48
        ReportName = "M365 Advanced Report 48"
...
if ($script:Results.Count -gt 0) {
    ...
    Write-Host "  Script Number: 48" -ForegroundColor White
...
Write-Host "Script 48 completed successfully.`n" -ForegroundColor Green
