...
<#
====================================================================================
Script Name: 50-Get-MicrosoftSecureScoreReport.ps1
Description: Microsoft 365 Advanced Reporting Script 50
...
param(
    ...
    [string]$ExportPath = ".\\M365_Advanced_Report_50_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)
...
Write-Host "Microsoft 365 Advanced Report - Script 50" -ForegroundColor Green  
Write-Host "====================================================================================`n" -ForegroundColor Cyan

# Module validation
$requiredModule = if (50 -eq 49) { "Microsoft.Graph.Identity.Governance" } else { "ExchangeOnlineManagement" }
...
Write-Host "Retrieving M365 data for script 50..." -ForegroundColor Cyan
$script:Results = @()
...
try {
    ...
    $reportData = @{
        ScriptNumber = 50
        ReportName = "M365 Advanced Report 50"
...
if ($script:Results.Count -gt 0) {
    ...
    Write-Host "  Script Number: 50" -ForegroundColor White
...
Write-Host "Script 50 completed successfully.`n" -ForegroundColor Green
