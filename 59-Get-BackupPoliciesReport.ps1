...
<#
====================================================================================
Script Name: 59-Get-BackupPoliciesReport.ps1
...
[CmdletBinding()]
param([string]$ExportPath = ".\Report_59_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv")

Write-Host "`n==================================================================================`n" -ForegroundColor Cyan
Write-Host "Backup Policies Report" -ForegroundColor Green
...
try {
    $data = [PSCustomObject]@{
        ReportName = "Backup Policies Report"
        ScriptNumber = 59
        Generated = Get-Date
...
Write-Host "Script 59 completed.`n" -ForegroundColor Green
