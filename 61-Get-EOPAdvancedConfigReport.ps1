...
<#
====================================================================================
Script Name: 61-Get-EOPAdvancedConfigReport.ps1
...
[CmdletBinding()]
param([string]$ExportPath = ".\Report_61_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv")

Write-Host "`n==================================================================================`n" -ForegroundColor Cyan
Write-Host "EOP Advanced Config Report" -ForegroundColor Green
...
try {
    $data = [PSCustomObject]@{
        ReportName = "EOP Advanced Config Report"
        ScriptNumber = 61
        Generated = Get-Date
...
Write-Host "Script 61 completed.`n" -ForegroundColor Green
