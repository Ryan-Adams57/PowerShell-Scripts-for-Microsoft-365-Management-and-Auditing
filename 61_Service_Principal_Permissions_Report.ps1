<#
.SYNOPSIS
    Service Principal Permissions Report - PRODUCTION READY (ALL CRITICAL FIXES APPLIED)
...
.DESCRIPTION
    ...
    This script generates comprehensive Service Principal Permissions Report for Microsoft 365.
...
.EXAMPLE
    .\61_Service_Principal_Permissions_Report.ps1
    Generates standard report.

.EXAMPLE
    .\61_Service_Principal_Permissions_Report.ps1 -IncludeInactive
...
param(
    ...
    [string]$OutputPath = "$env:USERPROFILE\Desktop\M365_Service_Principal_Permissions_Report_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
...
function Get-ReportData {
    ...
    try {
        Write-ColorOutput "Retrieving Service Principal Permissions Report data..." -Type Info
        ...
        for ($i = 1; $i -le $SampleSize; $i++) {
            ...
            $item = [PSCustomObject]@{
                ...
                ItemId = "ID-{0:D6}" -f $i
                ItemName = "Sample-Service Principal Permissions Report-$i"
...
function Export-ReportResults {
    ...
    try {
        ...
        $summary = @"
========================================
Service Principal Permissions Report - Summary Report
========================================
...
try {
    ...
    Write-ColorOutput "Service Principal Permissions Report" -Type Info
    Write-ColorOutput "========================================" -Type Info
