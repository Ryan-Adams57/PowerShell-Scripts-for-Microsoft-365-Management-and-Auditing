...
<#
====================================================================================
Script Name: 62-Get-PowerPlatformDLPPoliciesReport.ps1
...
[CmdletBinding()]
param([string]$ExportPath = ".\Report_62_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv")

Write-Host "`n==================================================================================`n" -ForegroundColor Cyan
Write-Host "Power Platform DLP Policies Report" -ForegroundColor Green
...
try {
    $data = [PSCustomObject]@{
        ReportName = "Power Platform DLP Policies Report"
        ScriptNumber = 62
        Generated = Get-Date
...
Write-Host "Script 62 completed.`n" -ForegroundColor Green
