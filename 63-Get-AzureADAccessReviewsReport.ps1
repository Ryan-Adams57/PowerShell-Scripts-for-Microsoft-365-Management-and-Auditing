...
<#
====================================================================================
Script Name: 63-Get-AzureADAccessReviewsReport.ps1
...
[CmdletBinding()]
param([string]$ExportPath = ".\Report_63_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv")

Write-Host "`n==================================================================================`n" -ForegroundColor Cyan
Write-Host "Azure AD Access Reviews Report" -ForegroundColor Green
...
try {
    $data = [PSCustomObject]@{
        ReportName = "Azure AD Access Reviews Report"
        ScriptNumber = 63
        Generated = Get-Date
...
Write-Host "Script 63 completed.`n" -ForegroundColor Green
