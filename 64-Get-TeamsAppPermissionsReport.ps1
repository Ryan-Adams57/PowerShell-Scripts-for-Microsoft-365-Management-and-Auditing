<#
Script 64: Teams App Permissions Report
Author: Ryan Adams
Website: https://www.governmentcontrol.net/
Production M365 PowerShell Script
#>

param([string]$ExportPath = ".\Report_64_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv")

Write-Host "`n==================================================================================`n" -ForegroundColor Cyan
Write-Host "Teams App Permissions Report" -ForegroundColor Green
...
try {
    $data = [PSCustomObject]@{
        ReportName = "Teams App Permissions Report"
        ScriptNumber = 64
        Generated = Get-Date
...
Disconnect-MgGraph | Out-Null
Write-Host "Script 64 completed.`n" -ForegroundColor Green
