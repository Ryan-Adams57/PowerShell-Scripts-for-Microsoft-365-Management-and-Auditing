...
<#
====================================================================================
Script Name: 65-Get-SharePointSiteCollectionsReport.ps1
...
[CmdletBinding()]
param([string]$ExportPath = ".\Report_65_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv")

Write-Host "`n==================================================================================`n" -ForegroundColor Cyan
Write-Host "SharePoint Site Collections Report" -ForegroundColor Green
...
try {
    $data = [PSCustomObject]@{
        ReportName = "SharePoint Site Collections Report"
        ScriptNumber = 65
        Generated = Get-Date
...
Write-Host "Script 65 completed.`n" -ForegroundColor Green
