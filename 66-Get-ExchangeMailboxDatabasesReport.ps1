...
<#
====================================================================================
Script Name: 66-Get-ExchangeMailboxDatabasesReport.ps1
...
[CmdletBinding()]
param([string]$ExportPath = ".\Report_66_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv")

Write-Host "`n==================================================================================`n" -ForegroundColor Cyan
Write-Host "Exchange Mailbox Databases Report" -ForegroundColor Green
...
try {
    $data = [PSCustomObject]@{
        ReportName = "Exchange Mailbox Databases Report"
        ScriptNumber = 66
        Generated = Get-Date
...
Write-Host "Script 66 completed.`n" -ForegroundColor Green
