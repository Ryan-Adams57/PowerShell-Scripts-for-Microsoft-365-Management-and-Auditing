...
<#
====================================================================================
Script Name: 67-Get-DefenderAttackSimulationReport.ps1
...
[CmdletBinding()]
param([string]$ExportPath = ".\Report_67_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv")

Write-Host "`n==================================================================================`n" -ForegroundColor Cyan
Write-Host "Defender Attack Simulation Report" -ForegroundColor Green
...
try {
    $data = [PSCustomObject]@{
        ReportName = "Defender Attack Simulation Report"
        ScriptNumber = 67
        Generated = Get-Date
...
Write-Host "Script 67 completed.`n" -ForegroundColor Green
