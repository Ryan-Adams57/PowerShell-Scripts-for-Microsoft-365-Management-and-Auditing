...
<#
====================================================================================
Script Name: 68-Get-AzureADEntitlementManagementReport.ps1
...
[CmdletBinding()]
param([string]$ExportPath = ".\Report_68_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv")

Write-Host "`n==================================================================================`n" -ForegroundColor Cyan
Write-Host "Azure AD Entitlement Management Report" -ForegroundColor Green
...
try {
    $data = [PSCustomObject]@{
        ReportName = "Azure AD Entitlement Management Report"
        ScriptNumber = 68
        Generated = Get-Date
...
Write-Host "Script 68 completed.`n" -ForegroundColor Green
