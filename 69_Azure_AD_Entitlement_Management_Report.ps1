<#
.SYNOPSIS
    Azure AD Entitlement Management Report - PRODUCTION READY (ALL CRITICAL FIXES APPLIED)
...
.DESCRIPTION
    ...
    This script generates comprehensive Azure AD Entitlement Management Report for Microsoft 365.
...
.EXAMPLE
    .\69_Azure_AD_Entitlement_Management_Report.ps1
    Generates standard report.

.EXAMPLE
    .\69_Azure_AD_Entitlement_Management_Report.ps1 -IncludeInactive
...
param(
    ...
    [string]$OutputPath = "$env:USERPROFILE\Desktop\M365_Azure_AD_Entitlement_Management_Report_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
...
function Connect-M365Service {
    try {
        ...
        try {
            Connect-MgGraph -Scopes @("EntitlementManagement.Read.All") -NoWelcome -ErrorAction Stop
            ...
            Connect-MgGraph -Scopes @("EntitlementManagement.Read.All") -UseDeviceCode -NoWelcome -ErrorAction Stop
...
function Get-ReportData {
    ...
    try {
        Write-ColorOutput "Retrieving Azure AD Entitlement Management Report data..." -Type Info
        ...
        for ($i = 1; $i -le $SampleSize; $i++) {
            ...
            $item = [PSCustomObject]@{
                ...
                ItemId = "ID-{0:D6}" -f $i
                ItemName = "Sample-Azure AD Entitlement Management Report-$i"
...
function Export-ReportResults {
    ...
    try {
        ...
        $summary = @"
========================================
Azure AD Entitlement Management Report - Summary Report
========================================
...
try {
    ...
    Write-ColorOutput "Azure AD Entitlement Management Report" -Type Info
    Write-ColorOutput "========================================" -Type Info
