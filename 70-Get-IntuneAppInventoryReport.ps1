...
<#
====================================================================================
Script Name: 70-Get-IntuneAppInventoryReport.ps1
...
[CmdletBinding()]
param([string]$ExportPath = ".\Report_70_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv")

Write-Host "`n==================================================================================`n" -ForegroundColor Cyan
Write-Host "Intune App Inventory Report" -ForegroundColor Green
...
try {
    $data = [PSCustomObject]@{
        ReportName = "Intune App Inventory Report"
        ScriptNumber = 70
        Generated = Get-Date
...
Write-Host "Script 70 completed.`n" -ForegroundColor Green
