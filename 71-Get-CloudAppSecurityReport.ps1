...
<#
====================================================================================
Script Name: 71-Get-CloudAppSecurityReport.ps1
...
[CmdletBinding()]
param([string]$ExportPath = ".\Report_71_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv")

Write-Host "`n==================================================================================`n" -ForegroundColor Cyan
Write-Host "Cloud App Security Report" -ForegroundColor Green
...
try {
    $data = [PSCustomObject]@{
        ReportName = "Cloud App Security Report"
        ScriptNumber = 71
        Generated = Get-Date
...
Write-Host "Script 71 completed.`n" -ForegroundColor Green
