...
<#
====================================================================================
Script Name: 72-Get-M365LicenseUsageTrendsReport.ps1
...
[CmdletBinding()]
param([string]$ExportPath = ".\Report_72_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv")

Write-Host "`n==================================================================================`n" -ForegroundColor Cyan
Write-Host "M365 License Usage Trends Report" -ForegroundColor Green
...
try {
    $data = [PSCustomObject]@{
        ReportName = "M365 License Usage Trends Report"
        ScriptNumber = 72
        Generated = Get-Date
...
Write-Host "Script 72 completed.`n" -ForegroundColor Green
