...
<#
====================================================================================
Script Name: 74-Get-TeamsPoliciesInventoryReport.ps1
...
[CmdletBinding()]
param([string]$ExportPath = ".\Report_74_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv")

Write-Host "`n==================================================================================`n" -ForegroundColor Cyan
Write-Host "Teams Policies Inventory Report" -ForegroundColor Green
...
try {
    $data = [PSCustomObject]@{
        ReportName = "Teams Policies Inventory Report"
        ScriptNumber = 74
        Generated = Get-Date
...
Write-Host "Script 74 completed.`n" -ForegroundColor Green
