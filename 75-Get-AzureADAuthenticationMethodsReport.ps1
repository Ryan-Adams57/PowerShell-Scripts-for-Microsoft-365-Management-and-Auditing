...
<#
====================================================================================
Script Name: 75-Get-AzureADAuthenticationMethodsReport.ps1
...
try {
    $data = [PSCustomObject]@{
        ReportName = "Azure AD Authentication Methods Report"
        ScriptNumber = 75
        Generated = Get-Date
...
Write-Host "Script 75 completed.`n" -ForegroundColor Green
