<#
.SYNOPSIS
    Exchange Transport Queue Report - PRODUCTION READY (ALL CRITICAL FIXES APPLIED)
...
.DESCRIPTION
    ...
    This script generates comprehensive Exchange Transport Queue Report for Microsoft 365.
...
.EXAMPLE
    .\076_Exchange_Transport_Queue_Report.ps1
    Generates standard report.

.EXAMPLE
    .\076_Exchange_Transport_Queue_Report.ps1 -IncludeInactive
...
param(
    ...
    [string]$OutputPath = "$env:USERPROFILE\Desktop\M365_Exchange_Transport_Queue_Report_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
...
function Get-ReportData {
    ...
    try {
        Write-ColorOutput "Retrieving Exchange Transport Queue Report data..." -Type Info
        ...
        for ($i = 1; $i -le $SampleSize; $i++) {
            ...
            $item = [PSCustomObject]@{
                ...
                ItemId = "ID-{0:D6}" -f $i
                ItemName = "Exchange Transport Queue Report-Sample-$i"
...
function Export-ReportResults {
    ...
    try {
        ...
        $summary = @"
========================================
Exchange Transport Queue Report - Summary Report
========================================
...
try {
    ...
    Write-ColorOutput "Exchange Transport Queue Report" -Type Info
    Write-ColorOutput "========================================" -Type Info
