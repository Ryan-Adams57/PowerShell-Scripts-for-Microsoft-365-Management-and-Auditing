<#
.SYNOPSIS
    SharePoint Permission Levels Report - PRODUCTION READY (ALL CRITICAL FIXES APPLIED)
...
.DESCRIPTION
    ...
    This script generates comprehensive SharePoint Permission Levels Report for Microsoft 365.
...
.EXAMPLE
    .\078_SharePoint_Permission_Levels_Report.ps1
    Generates standard report.

.EXAMPLE
    .\078_SharePoint_Permission_Levels_Report.ps1 -IncludeInactive
...
param(
    ...
    [string]$OutputPath = "$env:USERPROFILE\Desktop\M365_SharePoint_Permission_Levels_Report_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
...
function Connect-M365Service {
    try {
        ...
        try {
            Connect-MgGraph -Scopes @("Sites.FullControl.All") -NoWelcome -ErrorAction Stop
            ...
            Connect-MgGraph -Scopes @("Sites.FullControl.All") -UseDeviceCode -NoWelcome -ErrorAction Stop
...
function Get-ReportData {
    ...
    try {
        Write-ColorOutput "Retrieving SharePoint Permission Levels Report data..." -Type Info
        ...
        for ($i = 1; $i -le $SampleSize; $i++) {
            ...
            $item = [PSCustomObject]@{
                ...
                ItemId = "ID-{0:D6}" -f $i
                ItemName = "SharePoint Permission Levels Report-Sample-$i"
...
function Export-ReportResults {
    ...
    try {
        ...
        $summary = @"
========================================
SharePoint Permission Levels Report - Summary Report
========================================
...
try {
    ...
    Write-ColorOutput "SharePoint Permission Levels Report" -Type Info
    Write-ColorOutput "========================================" -Type Info
