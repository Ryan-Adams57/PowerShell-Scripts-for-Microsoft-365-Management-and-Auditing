<#
.SYNOPSIS
    Intune Device Configuration Report - PRODUCTION READY (ALL CRITICAL FIXES APPLIED)
...
.DESCRIPTION
    ...
    This script generates comprehensive Intune Device Configuration Report for Microsoft 365.
...
.EXAMPLE
    .\081_Intune_Device_Configuration_Report.ps1
    Generates standard report.

.EXAMPLE
    .\081_Intune_Device_Configuration_Report.ps1 -IncludeInactive
...
param(
    ...
    [string]$OutputPath = "$env:USERPROFILE\Desktop\M365_Intune_Device_Configuration_Report_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
...
function Connect-M365Service {
    try {
        ...
        try {
            ...
            Connect-MgGraph -Scopes @("DeviceManagementConfiguration.Read.All") -UseDeviceCode -NoWelcome -ErrorAction Stop
...
function Get-ReportData {
    ...
    try {
        Write-ColorOutput "Retrieving Intune Device Configuration Report data..." -Type Info
        ...
        for ($i = 1; $i -le $SampleSize; $i++) {
            ...
            $item = [PSCustomObject]@{
                ...
                ItemId = "ID-{0:D6}" -f $i
                ItemName = "Intune Device Configuration Report-Sample-$i"
...
function Export-ReportResults {
    ...
    try {
        ...
        $summary = @"
========================================
Intune Device Configuration Report - Summary Report
========================================
...
try {
    ...
    Write-ColorOutput "Intune Device Configuration Report" -Type Info
    Write-ColorOutput "========================================" -Type Info
