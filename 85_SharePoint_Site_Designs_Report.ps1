<#
.SYNOPSIS
    SharePoint Site Designs Report - PRODUCTION READY (ALL CRITICAL FIXES APPLIED)
...
.DESCRIPTION
    ...
    This script generates comprehensive SharePoint Site Designs Report for Microsoft 365.
...
.EXAMPLE
    .\085_SharePoint_Site_Designs_Report.ps1
    Generates standard report.

.EXAMPLE
    .\085_SharePoint_Site_Designs_Report.ps1 -IncludeInactive
...
param(
    ...
    [string]$OutputPath = "$env:USERPROFILE\Desktop\M365_SharePoint_Site_Designs_Report_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
...
function Get-ReportData {
    ...
    try {
        Write-ColorOutput "Retrieving SharePoint Site Designs Report data..." -Type Info
        ...
        for ($i = 1; $i -le $SampleSize; $i++) {
            ...
            $item = [PSCustomObject]@{
                ...
                ItemId = "ID-{0:D6}" -f $i
                ItemName = "SharePoint Site Designs Report-Sample-$i"
...
function Export-ReportResults {
    ...
    try {
        ...
        $summary = @"
========================================
SharePoint Site Designs Report - Summary Report
========================================
...
try {
    ...
    Write-ColorOutput "SharePoint Site Designs Report" -Type Info
    Write-ColorOutput "========================================" -Type Info
