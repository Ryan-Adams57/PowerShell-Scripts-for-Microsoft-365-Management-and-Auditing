<#
.SYNOPSIS
    Intune Compliance Policies Report - PRODUCTION READY (ALL CRITICAL FIXES APPLIED)
...
.DESCRIPTION
    ...
    This script generates comprehensive Intune Compliance Policies Report for Microsoft 365.
...
.EXAMPLE
    .\087_Intune_Compliance_Policies_Report.ps1
    Generates standard report.

.EXAMPLE
    .\087_Intune_Compliance_Policies_Report.ps1 -IncludeInactive
...
param(
    ...
    [string]$OutputPath = "$env:USERPROFILE\Desktop\M365_Intune_Compliance_Policies_Report_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
...
function Get-ReportData {
    ...
    try {
        Write-ColorOutput "Retrieving Intune Compliance Policies Report data..." -Type Info
        ...
        for ($i = 1; $i -le $SampleSize; $i++) {
            ...
            $item = [PSCustomObject]@{
                ...
                ItemId = "ID-{0:D6}" -f $i
                ItemName = "Intune Compliance Policies Report-Sample-$i"
...
function Export-ReportResults {
    ...
    try {
        ...
        $summary = @"
========================================
Intune Compliance Policies Report - Summary Report
========================================
...
try {
    ...
    Write-ColorOutput "Intune Compliance Policies Report" -Type Info
    Write-ColorOutput "========================================" -Type Info
