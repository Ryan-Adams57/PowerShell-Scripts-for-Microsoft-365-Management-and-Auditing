<#
.SYNOPSIS
    Teams Emergency Calling Report - PRODUCTION READY (ALL CRITICAL FIXES APPLIED)
...
.DESCRIPTION
    ...
    This script generates comprehensive Teams Emergency Calling Report for Microsoft 365.
...
.EXAMPLE
    .\088_Teams_Emergency_Calling_Report.ps1
    Generates standard report.

.EXAMPLE
    .\088_Teams_Emergency_Calling_Report.ps1 -IncludeInactive
...
param(
    ...
    [string]$OutputPath = "$env:USERPROFILE\Desktop\M365_Teams_Emergency_Calling_Report_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
...
function Get-ReportData {
    ...
    try {
        Write-ColorOutput "Retrieving Teams Emergency Calling Report data..." -Type Info
        ...
        for ($i = 1; $i -le $SampleSize; $i++) {
            ...
            $item = [PSCustomObject]@{
                ...
                ItemId = "ID-{0:D6}" -f $i
                ItemName = "Teams Emergency Calling Report-Sample-$i"
...
function Export-ReportResults {
    ...
    try {
        ...
        $summary = @"
========================================
Teams Emergency Calling Report - Summary Report
========================================
...
try {
    ...
    Write-ColorOutput "Teams Emergency Calling Report" -Type Info
    Write-ColorOutput "========================================" -Type Info
