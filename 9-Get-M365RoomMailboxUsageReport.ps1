...
• Shows booking policies and calendar processing settings
• Displays room capacity and location information
• Analyzes booking patterns and usage statistics
• Identifies underutilized or misconfigured rooms
• Supports filtering by location and capacity
...
USAGE EXAMPLES:
  .\9-Get-M365RoomMailboxUsageReport.ps1
  .\9-Get-M365RoomMailboxUsageReport.ps1 -Location "Building A"
  .\9-Get-M365RoomMailboxUsageReport.ps1 -MinimumCapacity 10
