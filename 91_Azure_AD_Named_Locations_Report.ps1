<#
.SYNOPSIS
    Azure AD Named Locations Report - PRODUCTION READY (ALL CRITICAL FIXES APPLIED)
...
.DESCRIPTION
    ...
    This script generates comprehensive Azure AD Named Locations Report for Microsoft 365.
...
.EXAMPLE
    .\091_Azure_AD_Named_Locations_Report.ps1
    Generates standard report.

.EXAMPLE
    .\091_Azure_AD_Named_Locations_Report.ps1 -IncludeInactive
...
param(
    ...
    [string]$OutputPath = "$env:USERPROFILE\Desktop\M365_Azure_AD_Named_Locations_Report_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
...
function Get-ReportData {
    ...
    try {
        Write-ColorOutput "Retrieving Azure AD Named Locations Report data..." -Type Info
        ...
        for ($i = 1; $i -le $SampleSize; $i++) {
            ...
            $item = [PSCustomObject]@{
                ...
                ItemId = "ID-{0:D6}" -f $i
                ItemName = "Azure AD Named Locations Report-Sample-$i"
...
function Export-ReportResults {
    ...
    try {
        ...
        $summary = @"
========================================
Azure AD Named Locations Report - Summary Report
========================================
...
try {
    ...
    Write-ColorOutput "Azure AD Named Locations Report" -Type Info
    Write-ColorOutput "========================================" -Type Info
