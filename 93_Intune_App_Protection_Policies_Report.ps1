<#
.SYNOPSIS
    Intune App Protection Policies Report - PRODUCTION READY (ALL CRITICAL FIXES APPLIED)
...
.DESCRIPTION
    ...
    This script generates comprehensive Intune App Protection Policies Report for Microsoft 365.
...
.EXAMPLE
    .\093_Intune_App_Protection_Policies_Report.ps1
    Generates standard report.

.EXAMPLE
    .\093_Intune_App_Protection_Policies_Report.ps1 -IncludeInactive
...
param(
    ...
    [string]$OutputPath = "$env:USERPROFILE\Desktop\M365_Intune_App_Protection_Policies_Report_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
...
function Connect-M365Service {
    try {
        ...
        try {
            ...
            Connect-MgGraph -Scopes @("DeviceManagementApps.Read.All") -UseDeviceCode -NoWelcome -ErrorAction Stop
...
function Get-ReportData {
    ...
    try {
        Write-ColorOutput "Retrieving Intune App Protection Policies Report data..." -Type Info
        ...
        for ($i = 1; $i -le $SampleSize; $i++) {
            ...
            $item = [PSCustomObject]@{
                ...
                ItemId = "ID-{0:D6}" -f $i
                ItemName = "Intune App Protection Policies Report-Sample-$i"
...
function Export-ReportResults {
    ...
    try {
        ...
        $summary = @"
========================================
Intune App Protection Policies Report - Summary Report
========================================
...
try {
    ...
    Write-ColorOutput "Intune App Protection Policies Report" -Type Info
    Write-ColorOutput "========================================" -Type Info
