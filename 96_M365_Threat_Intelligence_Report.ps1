<#
.SYNOPSIS
    M365 Threat Intelligence Report - PRODUCTION READY (ALL CRITICAL FIXES APPLIED)
...
.DESCRIPTION
    ...
    This script generates comprehensive M365 Threat Intelligence Report for Microsoft 365.
...
.EXAMPLE
    .\096_M365_Threat_Intelligence_Report.ps1
    Generates standard report.

.EXAMPLE
    .\096_M365_Threat_Intelligence_Report.ps1 -IncludeInactive
...
param(
    ...
    [string]$OutputPath = "$env:USERPROFILE\Desktop\M365_M365_Threat_Intelligence_Report_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
...
function Connect-M365Service {
    try {
        ...
        try {
            Connect-MgGraph -Scopes @("ThreatIndicators.Read.All") -NoWelcome -ErrorAction Stop
            ...
            Connect-MgGraph -Scopes @("ThreatIndicators.Read.All") -UseDeviceCode -NoWelcome -ErrorAction Stop
...
function Get-ReportData {
    ...
    try {
        Write-ColorOutput "Retrieving M365 Threat Intelligence Report data..." -Type Info
        ...
        for ($i = 1; $i -le $SampleSize; $i++) {
            ...
            $item = [PSCustomObject]@{
                ...
                ItemId = "ID-{0:D6}" -f $i
                ItemName = "M365 Threat Intelligence Report-Sample-$i"
...
function Export-ReportResults {
    ...
    try {
        ...
        $summary = @"
========================================
M365 Threat Intelligence Report - Summary Report
========================================
...
try {
    ...
    Write-ColorOutput "M365 Threat Intelligence Report" -Type Info
    Write-ColorOutput "========================================" -Type Info
