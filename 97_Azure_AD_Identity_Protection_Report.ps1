<#
.SYNOPSIS
    Azure AD Identity Protection Report - PRODUCTION READY (ALL CRITICAL FIXES APPLIED)
...
.DESCRIPTION
    ...
    This script generates comprehensive Azure AD Identity Protection Report for Microsoft 365.
...
.EXAMPLE
    .\097_Azure_AD_Identity_Protection_Report.ps1
    Generates standard report.

.EXAMPLE
    .\097_Azure_AD_Identity_Protection_Report.ps1 -IncludeInactive
...
param(
    ...
    [string]$OutputPath = "$env:USERPROFILE\Desktop\M365_Azure_AD_Identity_Protection_Report_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
...
function Connect-M365Service {
    try {
        ...
        try {
            ...
            Connect-MgGraph -Scopes @("IdentityRiskyUser.Read.All") -UseDeviceCode -NoWelcome -ErrorAction Stop
...
function Get-ReportData {
    ...
    try {
        Write-ColorOutput "Retrieving Azure AD Identity Protection Report data..." -Type Info
        ...
        for ($i = 1; $i -le $SampleSize; $i++) {
            ...
            $item = [PSCustomObject]@{
                ...
                ItemId = "ID-{0:D6}" -f $i
                ItemName = "Azure AD Identity Protection Report-Sample-$i"
...
function Export-ReportResults {
    ...
    try {
        ...
        $summary = @"
========================================
Azure AD Identity Protection Report - Summary Report
========================================
...
try {
    ...
    Write-ColorOutput "Azure AD Identity Protection Report" -Type Info
    Write-ColorOutput "========================================" -Type Info
