<#
.SYNOPSIS
    Intune Enrollment Restrictions Report - PRODUCTION READY (ALL CRITICAL FIXES APPLIED)
...
.DESCRIPTION
    ...
    This script generates comprehensive Intune Enrollment Restrictions Report for Microsoft 365.
...
.EXAMPLE
    .\099_Intune_Enrollment_Restrictions_Report.ps1
    Generates standard report.

.EXAMPLE
    .\099_Intune_Enrollment_Restrictions_Report.ps1 -IncludeInactive
...
param(
    ...
    [string]$OutputPath = "$env:USERPROFILE\Desktop\M365_Intune_Enrollment_Restrictions_Report_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
...
function Connect-M365Service {
    try {
        ...
        try {
            ...
            Connect-MgGraph -Scopes @("DeviceManagementServiceConfig.Read.All") -UseDeviceCode -NoWelcome -ErrorAction Stop
...
function Get-ReportData {
    ...
    try {
        Write-ColorOutput "Retrieving Intune Enrollment Restrictions Report data..." -Type Info
        ...
        for ($i = 1; $i -le $SampleSize; $i++) {
            ...
            $item = [PSCustomObject]@{
                ...
                ItemId = "ID-{0:D6}" -f $i
                ItemName = "Intune Enrollment Restrictions Report-Sample-$i"
...
function Export-ReportResults {
    ...
    try {
        ...
        $summary = @"
========================================
Intune Enrollment Restrictions Report - Summary Report
========================================
...
try {
    ...
    Write-ColorOutput "Intune Enrollment Restrictions Report" -Type Info
    Write-ColorOutput "========================================" -Type Info
